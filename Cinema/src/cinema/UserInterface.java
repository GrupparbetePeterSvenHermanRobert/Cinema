	...
	do
	{
		...
		case "1":
			...
			case "1":
				...
				System.out.println("Lista av filmer. \n"
						+ cinema.getFilms());	
				break;
			...
			case "3":
				...
				System.out.println(cinema.getFilms());
				//System.out.println(cinema.getViewingByTitle);
				System.out.println("Visa alla lediga platser");
				System.out.println("här skrivs ut alla lediagplatser");
				//här ska användaren skriva in TeaterId Start, seatID,TicketId (telefonnr)
				System.out.println("Skriv in Theater Id");
				String theaterInputId = reader.readLine();
				System.out.println("Skriv in ViweingId");
